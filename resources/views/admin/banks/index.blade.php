    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-4">
            ...
            <button type="button" class="btn text-white" style="background-color:#0056b3;"
                onclick="window.location='{{ route('banks.create') }}'">
                <i class="fa-solid fa-square-plus"></i> Add Bank Acc
            </button>
                            ...
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        @forelse($accounts as $account)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route('banks.destroy', $account->id) }}"
                                                        method="POST" style="display:inline;"
                                                        onsubmit="return confirm('Are you sure?');">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="btn btn-sm btn-danger">
                                                            <i class="fa-solid fa-trash-can text-dark text-gradient text-lg opacity-10"
                                                                aria-hidden="true"></i> <span
                                                                class="ms-1">Delete</span>
                                                        </button>
                                                    </form>
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
                                                <td colspan="7" class="text-center text-muted">No bank accounts
                                                    found.</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
