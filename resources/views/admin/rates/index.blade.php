    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-4">
            <button type="button" class="btn text-white" style="background-color:#0056b3;"
                onclick="window.location='{{ route('currency-rates.create') }}'">
                                    ...
                                    <tbody>
                                        @forelse($currencyRates as $rate)
                                            <tr>
                                                ...
                                                <td class="">
                                                    <a href="{{ route('currency-rates.edit', $rate->id) }}"
                                                ...
                                                <td class="">
                                                    <form action="{{ route('currency-rates.destroy', $rate->id) }}"
            ...
            {!! $currencyRates->withQueryString()->links('pagination::bootstrap-5') !!}
