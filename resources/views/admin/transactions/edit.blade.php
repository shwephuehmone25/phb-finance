            ...
            <div class="row justify-content-start">
                <div class="col-md-8">
                    <div class="card mb-4 p-4 shadow-sm">
                        ...
                        <form action="{{ route('transactions.update', $transaction->id) }}" method="POST" novalidate>
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <select name="status" id="status" class="form-select" required>
                                    ...
                                    @foreach ($statuses as $status)
                                        <option value="{{ $status }}"
                                            {{ old('status', $transaction->status) === $status ? 'selected' : '' }}>
                                            {{ $status }}
                                        </option>
                                    @endforeach
                                </select>
                                <div class="form-text">Select the current status of the transaction.</div>
                                @error('status')
