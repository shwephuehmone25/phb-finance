            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">create transaction
                        </li>
                    </ol>
                        ...
                        <form action="{{ route('transactions.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="direction" name="direction" required>
                                    ...
                                    <option value="BAHT_TO_MMK">Baht to MMK</option>
                                    <option value="MMK_TO_BAHT">MMK to Baht</option>
                                </select>
                            </div>

                            <div class="mb-3">
                                <label for="from_amount" class="form-label">From Amount</label>
                                <input type="number" step="0.01" class="form-control" id="from_amount"
                                    name="from_amount" required>
                            </div>

                            <div class="mb-3">
                                <label for="transfer_bill" class="form-label">Transfer Bill</label>
                                <input type="file" class="form-control" id="transfer_bill" name="transfer_bill" accept="image/*">
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="receiver_bank_account_no" class="form-label">Receiver Bank Account
                                    No</label>
                                <input type="text" class="form-control" id="receiver_bank_account_no"
                                    name="receiver_bank_account_no" required>
                            </div>
