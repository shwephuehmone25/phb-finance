                    ...
                    <div class="container-fluid pe-0">
                        ...
                        <div class="collapse navbar-collapse" id="navigation">
                            <ul class="navbar-nav mx-auto ms-xl-auto me-xl-7">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link me-2" href="{{ route('register.form') }}">
                                    ...
                                    <form role="form" method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="mb-3">
                                            <input type="phone_number" name="phone_number" class="form-control"
                                                placeholder="Enter your phone" aria-label="Phone Number"
                                                aria-describedby="ph-addon" required>
                                        </div>

                                        <label for="password">Password</label>
                                        <div class="mb-3 position-relative">
                                            <input type="password" name="password" class="form-control pr-5"
                        ...
                        <div class="col-md-6">
                            <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6"
                                    style="background-image:url('https://plus.unsplash.com/premium_photo-1681469490618-c24cc20bef1c?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8ZG9sbGFyfGVufDB8fDB8fHww')">
                                </div>
                            </div>
                        </div>
                    </div>
